...
<div class="container mt-5">
    ...
    <form method="post" action="/PROJETO_LUAN/panel/clube/edit/<?= $clube['id'] ?>">
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input value="<?= $clube['endereco'] ?>" type="endereco" required name="endereco" class="form-control" required>
        </div>
        <div class="mb-3">
            <label for="data-adesao" class="form-label">Data de Adesão:</label>
            <input value="<?= $clube['data_de_adesao'] ?>" type="data_de_adesao" required name="data_de_adesao"
        ...
        <div class="mb-3">
            ...
            <select class="form-select" id="tipo_de_membresia" name="tipo_de_membresia" required>
                ...
                <option <?= $clube['tipo_de_membresia'] == 'estudante' ? "selected" : "" ?> value="estudante">Estudante
                </option>
            </select>
        </div>
        <div class="mb-3">
